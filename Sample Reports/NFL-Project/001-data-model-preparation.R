...
S2014 <- read.csv('Data/pbp-2014.csv')
S2015 <- read.csv('Data/pbp-2015.csv')
S2016 <- read.csv('Data/pbp-2016.csv')
S2017 <- read.csv('Data/pbp-2017.csv')
S2018 <- read.csv('Data/pbp-2018.csv')
S2019 <- read.csv('Data/pbp-2019.csv')
...
save(data_train.notna, file = "Data/data_train_FeatEng.RData")
