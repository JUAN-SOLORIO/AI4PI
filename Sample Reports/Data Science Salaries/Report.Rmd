---
title: "The effects of Job Title and Programming Preference in Compensation for Data Scientists"
author: "Juan Solorio"
output: 
  pdf_document: 
    df_print: kable
...
## Abstract
The goal of this project is to determine whether there are differences in salary for working data scientists based on certain factors (such as job title and programming language preference). To that end, I emplyed techniques such as Welch t-tests, ANOVA, and regression on data provided by Kaggle's 2017 "ML and DS Survey" (https://www.kaggle.com/kaggle/kaggle-survey-2017). The factors explored in this project are job title ('Data Scientist, 'Engineer', etc), and recommended programming language (Python, R, SQL). I found evidence that data scientists' salaries differ based on job titles. However, we did not find sufficient evidence for differences in salary based on programming language, even within individual job titles.

## Introduction

As prospective employee in the field, I have an interest in which factors might affect current data scientists' pay. For this reason I conducted our analyses on a dataset from Kaggle which is the result of a recent industry-wide survey conducted on data science professionals. This data is described in more detail in the following section. After some exploration of the data, I formulated two questions to guide the analysis.

**Question 1**: Do data scientists' salaries differ based on their job title?

**Question 2**: Do these salaries differ based on their recommendation of programming language?
